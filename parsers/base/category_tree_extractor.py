...
from parsers.base.category_interaction import find_selenium_element
from parsers.base.category_clicker import click_category_with_fallback
from parsers.base.category_interaction_detector import detect_menu_behavior
                ...
                try:
                    ...
                    if selenium_elem:
                        ...
                        if menu_behavior == "hover":
                            # hover만 시도
                            from parsers.base.category_interaction import hover_element, hover_and_wait_for_submenu
